...
-- Run this in your Supabase SQL Editor to create the forum tables
...
('Welcome to the Community Forum!', 'This is a welcome post to get the forum started. Feel free to introduce yourself and start discussions about learning roadmaps, programming, or any other topics!', (SELECT id FROM auth.users LIMIT 1), 'announcements', ARRAY['welcome', 'community']),
('How to Create Your First Roadmap', 'I''m new to creating roadmaps and would love some tips on how to get started. What tools do you recommend?', (SELECT id FROM auth.users LIMIT 1), 'questions', ARRAY['roadmaps', 'beginner', 'tips']),
('Best Learning Resources for React', 'Share your favorite React learning resources, tutorials, and courses. Let''s help each other learn!', (SELECT id FROM auth.users LIMIT 1), 'discussions', ARRAY['react', 'learning', 'resources'])
